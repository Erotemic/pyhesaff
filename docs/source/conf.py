...
Notes:
    ...
    rm -rf ~/code/pyhesaff/docs/source/auto
    cd ~/code/pyhesaff/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/pyhesaff/docs/source/auto ~/code/pyhesaff/pyhesaff
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/pyhesaff/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: pyhesaff
            Set the Repository URL: https://github.com/Erotemic/pyhesaff

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/pyhesaff/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/pyhesaff/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/pyhesaff/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'pyhesaff')
...
# html_logo = '.static/pyhesaff.svg'
# html_favicon = '.static/pyhesaff.ico'
...
latex_documents = [
    (master_doc, 'pyhesaff.tex', 'pyhesaff Documentation',
     'Krystian Mikolajczyk Michal Perdoch Jon Crall Avi Weinstock', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyhesaff', 'pyhesaff Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyhesaff', 'pyhesaff Documentation',
     author, 'pyhesaff', 'One line description of project.',
     'Miscellaneous'),
]
